...
const Questions = [{
        id: 0,
        q: "What was Marvel's first movie?",
        a: [{ text: "Avengers", isCorrect: false },
            { text: "Thor", isCorrect: false },
            { text: "Iron Man", isCorrect: true },
            { text: "Endgame", isCorrect: false }
        ]
  
    },
    {
        id: 1,
        q: "What was Thor's power?",
        a: [{ text: "Mind Reading", isCorrect: false, isSelected: false },
            { text: "Speed", isCorrect: false },
            { text: "Strength", isCorrect: false },
            { text: "Lighting", isCorrect: true }
        ]
  
    },
    {
        id: 2,
        q: "When did Avengers Endgame come out?",
